...
from src.routes.walker import walker_bp
from src.routes.dog import dog_bp
from src.routes.walk import walk_bp
...
app.register_blueprint(walker_bp, url_prefix='/api')
